...
const initialState = {
    holidays: [
        ...
        {type: "success", content: "День рождение Ивана", day: 11, month:2},
        {type: "success", content: "День рождение Ивана", day: 13, month:2},
        {type: "success", content: "День рождение Ивана", day: 15, month:2},
        {type: "success", content: "День рождение Ивана", day: 21, month:2},
    ]
}
